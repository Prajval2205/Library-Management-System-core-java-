...
public class BookServiceImpl implements BookServiceInterface {
    ...
    public void showAllBooks() {
       ...
       System.out.println("\n----------------------------------------------------------------------------------------------");
        ...
        System.out.println("\n----------------------------------------------------------------------------------------------");
       if(flag==false)
           System.out.println(RESET+"There are no Books in Library"+RESET);
    }
    public void showAllAvailableBooks(){
        ...
        if(books.size()>0){
            ...
            System.out.println(RESET+"No Books Available in the library"+RESET);
        }
        System.out.println("\n----------------------------------------------------------------------------------------------");
        if(flag==false)
            System.out.println(RESET+"There are no books with status Available"+RESET);
    ...
    public void borrowBook(){
       ...
       if(flag==false)
           System.out.println(RESET+"This book is not available to borrow"+RESET);
    ...
    public void returnBook(){
        ...
        if(flag==false)
            System.out.println(RESET+"We can not return this book"+RESET);
